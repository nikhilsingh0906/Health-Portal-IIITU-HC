     ...
     contactUs.find({},function(err,contactus){
          ...
          router
            ...
            router
                     ...
                     .get((req,res,next)=>{
                      ...
                      appointments.findOne({_id: requestedapointmentId},function(err,apointment){
                     ...
                     .get((req,res,next)=>{
                      ...
                      appointments.findByIdAndDelete(requestedapointmentId, function (err) {
                        if(err) console.log(err);
      ...
      .get((req, res)=>{
        ...
        //let student=appointment.find({}).sort({'timestamps':-1}).limit(1);
          appointments.findOne({email:requestedStudentId}).sort({'_id':-1}).limit(1).exec(function(err, appointmentD){
          //if(student){  
